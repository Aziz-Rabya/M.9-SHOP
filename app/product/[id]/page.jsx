  ...
  useEffect(() => {
    if (id) {
      ...
      if (product) {
        ...
        setMainImage(product.image[0]); // set default image
      }
    }
  }, [id]);

  if (!productData) return <p className="p-10">Loading...</p>;
    ...
    <>
      ...
      <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="mt-6 space-y-2 text-gray-700">
              ...
              <p>
                <span className="font-medium">Color:</span> {productData.color}
              </p>
              <p>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="gap-8 px-20 flex flex-wrap">
              <ProductCard />
          </div>

          <button className="px-8 py-2 mb-16 border rounded text-gray-500/70 hover:bg-slate-50/90 transition mt-10">
            See more
          </button>
        </div>
      </div>
